<div class="btn-group btn-group-sm" role="group">
    <a href="{{ route('admin.delivery-options.show', $option->id) }}"
       class="btn btn-info p-1 mx-1" title="View">
        <i class="fas fa-eye"></i>
    </a>

    <a href="{{ route('admin.delivery-options.edit', $option->id) }}"
       class="btn btn-primary p-1 mx-1" title="Edit">
        <i class="fas fa-edit bg-none"></i>
    </a>

    <form width="0px"  action="{{ route('admin.delivery-options.destroy', $option->id) }}"
